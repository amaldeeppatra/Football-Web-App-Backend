...
const fs = require('fs');
const RecentMatches = require('../../../../models/data/recentmatches');
...
async function recentMatchesData(req, res) {
  try {
    ...
    for (const row of data) {
      ...
      const result = await RecentMatches.findOneAndUpdate(filter, update, options);
...
module.exports = { recentMatchesData };
